...
if(temperature >= 80 && rain === true){
  ...
  console.log("Cne should wear a jacket and carry an umbrella.");
}else if(temperature >= 80 && rain === false){
  console.log("Just a t-shirt will do.");
}else if(60 < temperature < 80 && rain === false){
  console.log("A light jacket will do.");
}else if(temperature <= 60 && rain === false){
  console.log("A warmer jacket is needed.");
}else{
...
while(score < passingScore){
  score += 1
  console.log("Score isn't high enough.");
}
